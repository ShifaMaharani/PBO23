...
from module import luas_prismasegitiga, luas_sisi, volume_prismasegitiga
...
def hitung_luasalas():
    ...
    luasalas = luas_prismasegitiga(alas,tinggi,luas,tinggiprisma,sisi1,sisi2,sisi3)
...
def hitung_luassisi():
    ...
    luassisi = luas_sisi(alas,tinggi,luas,tinggiprisma,sisi1,sisi2,sisi3)
...
def hitung_volume():
    ...
    volume = volume_prismasegitiga(alas,tinggi,luas,tinggiprisma,sisi1,sisi2,sisi3)
