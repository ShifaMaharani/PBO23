...
from module import luas_selimut,luas_permukaan, volume_silinder

def hitung_luasselimut():
    jarijari = float(txtjarijari.get())
    tinggi = float(txttinggi.get())

    luasselimut = luas_selimut(jarijari, tinggi)
...
def hitung_luaspermukaan():
    ...
    luaspermukaan = luas_permukaan(jarijari, tinggi)
...
def hitung_volume():
    ...
    Volume =  volume_silinder(jarijari, tinggi)
