...
from module import luas_selimutkerucut, luas_permukaankerucut, volume_kerucut
...
def hitung_luasselimut():
    ...
    luasselimut = luas_selimutkerucut(jarijari, sisi, tinggi)
...
def hitung_luaspermukaan():
    ...
    luaspermukaan = luas_permukaankerucut(jarijari, sisi, tinggi)
...
def hitung_volume():
    ...
    Volume = volume_kerucut (jarijari, sisi, tinggi )
