...
from module import luas_limassegitiga, volume_limassegitiga
...
def hitung_luaspermukaan():
    ...
    luas = luas_limassegitiga(alassegitiga, tinggilimas, tinggisegitiga)
...
def hitung_volume():
    ...
    Volume = volume_limassegitiga(alassegitiga, tinggilimas, tinggisegitiga)
